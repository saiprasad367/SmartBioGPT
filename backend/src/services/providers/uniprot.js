 ...
 *
 * Ranked strategy so that "TP53" returns TP53 and not a protein that merely
 * mentions it: exact accession -> exact gene symbol (reviewed) -> gene/name
 * match (reviewed) -> anything.
 */
async function search(query) {
    ...
    // Human-first: a biomedical research tool should return the human ortholog
    // by default, then fall back to any reviewed entry, then anything.
