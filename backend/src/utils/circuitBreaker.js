 ...
 *
 * Protects the API from hammering an external database that is already failing,
 * and gives fast, predictable failures to the caller (which can then fall back
 * to partial results) instead of piling up slow requests.
 */
